...
\begin{align*}
    \mathcal{A} = \bigCurl{
        \begin{pmatrix}
            \A{1} & \dots & \A{L}
        \end{pmatrix} : \|\A{i}\|_\sigma \le s_i, \|(\A{i} - \M{i})^T\|_{2, 1}\le a_i, \|\A{L} - \M{L}\|_F \le a_L
    }
\end{align*}
...
\begin{align*}
    \tau_{L-1} = \sum_{j=1}^{L-1}\epsilon_j \biggRound{\prod_{j+1}^{L-1} s_l\rho_{l-1}}
\end{align*}
...
\begin{align*}
    \F_L(\vecbf{\bA{1, L-1}}) = \biggCurl{
        x \mapsto \A{L}F_\vecbf{\bA{1, L-1}}(x) : \|\A{L}-\M{L}\|_F \le a_L
    }
\end{align*} 
...
\begin{align*}
    ...
    &\le |\mathcal{C}_{L-1}| \cdot \sup_{
        ...
        \bigCurl{
            x \mapsto \A{L}F_\vecbf{\A{1, L-1}}(x) : \|\A{L} - \M{L}\|_F \le a_L
        }, \epsilon_L, \|.\|_*^S
    } \ \ \ (2)
\end{align*}
...
\begin{align*}
    ...
    &\le \frac{36a_L^2\prod_{1\le l \le L-1}\rho_l^2s_l^2}{\epsilon_L^2}\log\biggRound{
        \biggRound{
            \frac{8a_L\prod_{1\le l \le L-1}\rho_l^2s_l^2}{\epsilon_L} + 7
        }nd_L
    } \\
    &\le \frac{36a_L^2\prod_{1\le l \le L-1}\rho_l^2s_l^2}{\epsilon_L^2}\log\biggRound{
        \biggRound{
