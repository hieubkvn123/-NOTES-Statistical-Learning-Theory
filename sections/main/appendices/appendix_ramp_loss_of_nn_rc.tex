...
\begin{proof*}[Theorem \ref{thm:nn_cover_bound_with_general_norm}]
    ...
    \noindent Now, construct the minimum cover $\mathcal{C}_i$ as followed:
    \begin{align*}
        \mathcal{C}_i = \bigcup_{\vecbf{\bA{1, i-1}} \in \mathcal{C}_{i-1}}\biggCurl{
            (\bA{1}, \dots, \bA{i-1}, \bA{i}) : \Big\|
                \bigRound{\A{i} - \bA{i}}F_\vecbf{\bA{1, i-1}}(Z)
            \Big\|_i \le \epsilon_i, \ \bA{i} \in \mathcal{B}_i
        }
    \end{align*}
\end{proof*}
