...
\textbf{1. Bounding the covering number of $\mathcal{L}_r$} : Let $\vecbf{w}, \vecbf{\bar w}\in W$. For any pair $(x_i, y_i) \in S$, we have:
\begin{align*}
...
Let $L_\vecbf{w} \in \mathcal{L}_r$ where
\begin{align*}
