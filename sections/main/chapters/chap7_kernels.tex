...
\begin{proof*}[Corollary \ref{coro:hilbert_space_direct_sum}]
    ...
    \begin{align*}
        \|f - x \| \le \|f - v\|, \ \forall v \in V
    \end{align*}

    \noindent Letting $y = f - x$, we have:
    \begin{align*}
        \|y\| \le \|y + (x - v)\|, \ \forall v \in V
    \end{align*}

    \noindent Since both $x, v \in V$ and $V$ is a vector space (closed under addition and scalar multiplication), we have $x - v \in V$. Therefore, we can write:
    \begin{align*}
        \|y\| \le \|y + v\|, \ \forall v\in V
    \end{align*}
    
    \noindent The above inequality holds if and only if:
    \begin{align*}
        \inner{y, v} = 0, \ \forall v \in V \implies y \in V^\perp
    \end{align*}

    \noindent Therefore, for all $f\in H$, we can write:
    \begin{align*}
        f = x + y, \ x \in V, \ y \in V^\perp
    \end{align*}

    \noindent Hence, $H = V \oplus V^\perp$.
\end{proof*}
