...
\begin{solution*}[Exercise \ref{ex:exercise_5.4}]
    ...
    \begin{subproof}{\newline ${\bf (b)}$ $\X=\R^d, \Hf=\{ \1{x \in C} : C \text{ is a closed sphere }\}$}
        ...
        \begin{align*}
            \F_2 = \biggCurl{
                f:\R^d \to \R \Big| f({\bf x}) = c^2 - \sum_{i=1}^d (x_i - a_i)^2, c\in \R, a_i \in \R
            }    
        \end{align*}
        
        \noindent Where $c$ denotes the radius of the hypersphere and the vector $(a_1, \dots, a_d)^T\in\R^d$ is the coordinates of the center. We can rewrite the class of classifiers as followed:
        \begin{align*}
