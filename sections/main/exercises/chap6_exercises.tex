    ...
    \begin{subproof}{Compute $P\bigRound{\bigAbs{X_j - Y_j} = z}$ for $z\ne 0$}
        ...
        \begin{align*}
            P\bigRound{X_j = z + Y_j}
                &= \sum_{y=1}^{n_j - z} P(X_j = z + Y_j | Y_j = y)P(Y_j = y) \\
                &= \sum_{y=1}^{n_j - z} \biggSquare{\begin{pmatrix} n_j \\ z + y \end{pmatrix} \frac{1}{2^{n_j}}} \biggSquare{ \begin{pmatrix} n_j \\ y \end{pmatrix} \frac{1}{2^{n_j}} } \\
                &= \frac{1}{2^{2n_j}}\sum_{y=1}^{n_j-z} \begin{pmatrix} n_j \\ y \end{pmatrix} \begin{pmatrix} n_j \\ z + y \end{pmatrix} \\
                &= \frac{1}{2^{2n_j}}\sum_{y=1}^{n_j-z} \begin{pmatrix} n_j \\ y \end{pmatrix} \begin{pmatrix} n_j \\ n_j - z - y \end{pmatrix} \\
